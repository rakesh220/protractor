...
element(by.xpath('//*[@id="navbar"]/ul/li[8]/a/i')).click();
 ...
 element(by.xpath('//*[@id="navbar"]/ul/li[8]/a/ul/li[17]/a')).click();
  ...
  //2 login with invalid username and correct password
    it('login with invalid username and correct password', function() {
        browser.get('https://chatapp.aadhya-analytics.com:4201');
        browser.waitForAngularEnabled(false);
      element(by.id("Username")).sendKeys("rakesh1");
      element(by.id("Password")).sendKeys("rakesh");
      element(by.buttonText("Sign In")).click();
     browser.driver.sleep(30000);  
     ...
     // 4) User should be able use forgot password
       it('User should be able use forgot password', function() {
        browser.get('https://chatapp.aadhya-analytics.com:4201');
        browser.waitForAngularEnabled(false);
     ...
     it('User getting reset password', function() {
      ...
      element(by.buttonText("Sign In")).click();
      browser.driver.sleep(30000);
      element(by.id('oldPassword')).sendKeys("rakesh");
      browser.driver.sleep(30000);
   ...
   browser.driver.sleep(40000);  
      ...
      //6) As a user i should be able to change password and set a new one.
  ...
  element(by.xpath('//*[@id="prefSettings"]/div/div/div[2]/div/div/div/div[1]/ul/li[3]/a')).click();
   browser.driver.sleep(10000);    
      element(by.xpath('//*[@id="oldPassword"]')).sendKeys("rakesh");
      element(by.xpath('//*[@id="newPassword"]')).sendKeys("rakesh1");
      element(by.xpath('//*[@id="confirmPassword"]')).sendKeys("rakesh1");
      element(by.xpath('//*[@id="prefSettings"]/div/div/div[3]/button[2]')).click();
       browser.driver.sleep(30000); 
       element(by.xpath('//*[@id="prefSettings"]/div/div/div[3]/button[1]')).click();
       browser.driver.sleep(30000); 
